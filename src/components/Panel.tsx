...
import NotificationsDropdown from "@/src/components/Panel/Notifications/NotificationsDropDown";
import SettingsModal from "@/src/components/Panel/Settings/Settings";

// Кастомный хук для закрытия модалок при смене роута
